...
" let g:airline_theme = 'dracula'"coc#pum#visible() ? coc#pum#prev(0) : "\
" let g:airline_theme = 'base16'coc#pum#visible() ? coc#pum#prev(0) : "\
...
" CTRL Pcoc#pum#visible() ? coc#pum#next(0) : "\
